...
- Design progress: **83% (57/69 accepted milestone points)**
- Current delivery: **1 ACTIVE / 0 READY / 0 BLOCKED / 0 BACKLOG / 0 MERGED PENDING ACCEPTANCE**
- Accepted validation baseline: `1e4f8ac80cc52e26a142bef8bc000e0be50321e6`
- Updated: **2026-08-25**
...
```mermaid
flowchart TB
  PM["PM / Integrator<br/>Design 83% (57/69)<br/>Now: 1 ACTIVE workstreams coordinated"]
  PM --> PMO["Architecture & Program Office<br/>Design 100% (5/5)<br/>Now: ACTIVE PM-RESIDUAL-DECOMPOSE-002 — Reconcile the 12 remaining recovered design points to source-backed deliverables"]
...
|---|---:|---|
| Architecture & Program Office (`pm-integrator`) | **100% (5/5)** | ACTIVE PM-RESIDUAL-DECOMPOSE-002 — Reconcile the 12 remaining recovered design points to source-backed deliverables |
...
|---|---|---|---|---|---|
| P1 | **ACTIVE** | `PM-RESIDUAL-DECOMPOSE-002` — Reconcile remaining recovered design points to source-backed deliverables | `pm-integrator` | Trace the remaining 12 design points back to repository design contracts and objective readiness gaps; do not invent historical milestone labels or award completion credit until each residual deliverable is explicit. | — |
