...
Progress and final delivery use the same registry-backed contract: five major-gate summaries for routine operation, followed by the decision-facing final report; the compact appendix retains all 33 stage identities/statuses and the immutable trace artifact retains exact detail. See `docs/V05_WORKFLOW_CONTRACT.md` and `docs/LIVE_PRIMARY_CLI.md`.
