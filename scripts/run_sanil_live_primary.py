...
- Down / Core / Bull: **{values['Down']:,.0f}원 / {values['Core']:,.0f}원 / {values['Bull']:,.0f}원**
...
현재가는 확률가중 기대값이 아니라 개별 Down/Core/Bull 세계관과 비교해야 합니다. 역사적 calibration cohort가 아직 충분하지 않아 Expected Value는 의도적으로 산출하지 않았습니다. 이 보고서의 FCFF 경로는 회사 가이던스가 아니라 2025 사업보고서와 2026년 2분기 IR을 기반으로 한 PRISM bounded underwrite입니다.

## Source Register

- 2025 사업보고서: {snapshot.sources['annual_report']['source_ref']}
- 2026년 2분기 IR: {snapshot.sources['q2_ir']['source_ref']}
- Risk snapshot methodology: {snapshot.sources['risk_snapshot']['source_ref']}
