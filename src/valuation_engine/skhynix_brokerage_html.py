...
_CSS = """
html{background:#eef1f4;color:#152033;font-family:Pretendard,'Noto Sans KR','Malgun Gothic',sans-serif}body{margin:0;line-height:1.55}.report{padding:24px 0}.page{width:min(210mm,calc(100vw - 24px));min-height:297mm;margin:0 auto 18px;padding:15mm;background:#fff;box-shadow:0 8px 28px #112a4620;position:relative}.page:after{content:attr(data-page);position:absolute;right:15mm;bottom:8mm;color:#8792a2;font-size:9pt}.mast{display:flex;justify-content:space-between;border-bottom:3px solid #112a46;padding-bottom:8px;color:#112a46;font-weight:800}.eyebrow{margin-top:18px;color:#1f5f9b;font-weight:800}h1{font-size:28pt;line-height:1.18;color:#112a46}h2,h3{color:#112a46}.hero,.two,.cards{display:grid;grid-template-columns:1.4fr .8fr;gap:18px}.two,.cards{grid-template-columns:1fr 1fr}.box{border:1px solid #d9e1e8;padding:14px;background:#fbfdff}.box.warn{background:#fff8eb;border-left:4px solid #b88719}.box.risk{background:#fff4f2;border-left:4px solid #b42318}.metric{display:flex;justify-content:space-between;border-top:1px solid #d9e1e8;padding:7px 0;font-size:10pt}.scenarios{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin:18px 0}.scenario{border:1px solid #d9e1e8;padding:12px}.scenario.core{background:#eaf3fb}.scenario strong{display:block;font-size:17pt;color:#112a46}table{width:100%;border-collapse:collapse;font-size:10pt}th,td{padding:8px;border-bottom:1px solid #d9e1e8;text-align:left}thead th{background:#112a46;color:white}.cards img{display:block;width:100%;border:1px solid #d9e1e8}.muted{color:#667487}.ai{background:#f1faf8;border:1px solid #b7d8d2;padding:14px}a{color:#1f5f9b}@media(max-width:760px){.page{width:100%;min-height:0;box-shadow:none}.hero,.two,.cards,.scenarios{grid-template-columns:1fr}}@page{size:A4;margin:0}@media print{html{background:white}.page{width:210mm;margin:0;box-shadow:none;break-after:page}}
"""
